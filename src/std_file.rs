...
, typed : None})},]},
	...
	dep : vec![Open::Mod(true, common::Ident::new("allocator", common::Location::default()), None),Open::Use(common::Path::new(vec![common::NamePath::Name(common::Ident::new("allocator", common::Location::default())),common::NamePath::Name(common::Ident::new("testing", common::Location::default())),], common::Location::default()),None),],
	err_reporter : common::ErrorReporter::empty(),
}
;
let mut submodules = HashMap::new();submodules.insert("allocator".to_string(), (true, 
{let file = File {
